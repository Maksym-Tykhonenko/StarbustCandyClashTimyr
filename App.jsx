...
import { Animated, View,Image, ImageBackground, TouchableOpacity } from 'react-native';
...
import CandyDetail from "./src/screens/CandyDetail.tsx";
import SweetDetailScreen from "./src/screens/SweetDetailScreen.tsx";
import CandyGameScreen from "./src/screens/CandyGameScreen.tsx";
import ResultScreen from "./src/screens/ResultScreen.tsx";
import AddCandyScreen from "./src/screens/AddCandyScreen.tsx";
import AboutDeveloperScreen from "./src/screens/AboutDeveloperScreen.tsx";
import FavoritesScreen from "./src/screens/FavoritesScreen.tsx";
const Stack = createStackNavigator();
import StarbustCandyClashProdScr from './src/screens/StarbustCandyClashProdScr.js';
// libs
...
const BackButton = () => {
    ...
    return (
        <TouchableOpacity onPress={() => navigation.goBack()} style={{marginLeft: 16}}>
            <Image source={require('./src/assets/img/weui_arrow-filled.png')} />
        </TouchableOpacity>
    );
};
...
export default function App({ navigation }) {
  ...
  const INITIAL_URL = `https://echo-raven-strata.space/`;
  const URL_IDENTIFAIRE = `slHYur5d`;
  ...
  OneSignal.initialize('1aaba48c-f81e-4f85-9498-483f08f9cc2f');
    ...
    const Route = ({ isFatch }) => {
            ...
            return (
                <Stack.Navigator>
                    <Stack.Screen
                        ...
                        name="StarbustCandyClashProdScr"
                        component={StarbustCandyClashProdScr}
        ...
        return (
            <Stack.Navigator screenOptions={{
                ...
                headerTitleStyle: { color: '#fff', fontSize: 18, fontWeight: '900' },
                headerTitle: 'Starbust Candy Clash',
                headerLeft: BackButton,

            }}>

                <Stack.Screen name="MainTab" component={MainTabNavigator} options={{ headerShown: false }} />
                <Stack.Screen name="CandyDetail" component={CandyDetail} options={{}} />
                <Stack.Screen name="SweetDetailScreen" component={SweetDetailScreen} options={{ headerShown: false }} />
                <Stack.Screen name="CandyGameScreen" component={CandyGameScreen} options={{ headerShown: false }} />
                <Stack.Screen name="Result" component={ResultScreen} options={{ headerShown: false }} />
                <Stack.Screen name="AddCandyScreen" component={AddCandyScreen} options={{}} />
                <Stack.Screen name="AboutDeveloperScreen" component={AboutDeveloperScreen} options={{}} />
                ...
                <NavigationContainer>
                    {!louderIsEnded ? (
                        <View style={{ flex: 1, position: 'relative', }}>
                            <Animated.Image source={require('./src/assets/img/loader.png')} style={{
                                //...props.style,
